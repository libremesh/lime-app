...
describe('Invalidate Voucher Page', () => {
    ...
    it('ask if user is sure of invalidating', async () => {
        ...
        expect(await screen.findByText('If you invalidate this voucher no one will be able to use it anymore. This cannot be reverted.')).toBeVisible();
