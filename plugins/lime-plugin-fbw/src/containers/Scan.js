        ...
        <div class="container container-padded">
                            ...
                            <div class="container">
                                {networks.length === 0 && (
                                    <p>
                                        :({" "}
                                        <Trans>
                                            No network found, try realigning
                                            your node and rescanning.
                                        </Trans>
                                    </p>
                                )}
                                {networks.length > 0 && (
                                            ...
                                            {networks.map((network, key) => {
                                                return (
                                                    <option
                                                        key={key}
                                                        value={key}
                                                    >{`${network.ap} (${network.config.wifi.ap_ssid})`}</option>
                                                );
                                            })}
                                        </select>
                                        <label>
            ...
            {state.error && (
                <Toast
                    text={
                        <Trans>
                            Must select a network and a valid hostname
                        </Trans>
                    }
                />
            )}
