...
alignRow.args = {
    queries: [
        [
            ["bat-hosts", "get_bathost", station.mac, "wlan1-mesh"],
            { hostname: "ql-graciela", iface: "wlan1-mesh" },
        ],
    ],
};
...
alignPage.args = {
    queries: [
        ...
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a0", "wlan1-mesh"],
            { hostname: "ql-rocio", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a1", "wlan1-mesh"],
            { hostname: "ql-martinez", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a2", "wlan2-mesh"],
            { hostname: "ql-jorge", iface: "wlan2-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a3", "wlan2-mesh"],
            { hostname: "ql-tanque", iface: "wlan1-mesh" },
        ],
    ],
};
...
alignPageLotOfNeighbours.args = {
    queries: [
        ...
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a2", "wlan1-mesh"],
            { hostname: "ql-jorge", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a3", "wlan1-mesh"],
            { hostname: "ql-marisa", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a4", "wlan1-mesh"],
            { hostname: "ql-guada", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a5", "wlan1-mesh"],
            { hostname: "ql-quinteros", iface: "wlan1-mesh" },
        ],
        [
            ["bat-hosts", "get_bathost", "52:00:00:ab:cd:a6", "wlan1-mesh"],
            { hostname: "ql-irene", iface: "wlan1-mesh" },
        ],
    ],
};
...
export const alignSingle = () => (
    <AlignSingle iface={"wlan1-mesh"} mac={"52:00:00:ab:cd:a0"} />
);
alignSingle.args = {
    queries: [
        [
...
export const alignSingleNoAssociated = () => (
    <AlignSingle iface={"wlan1-mesh"} mac={"52:00:00:ab:cd:a0"} />
);
