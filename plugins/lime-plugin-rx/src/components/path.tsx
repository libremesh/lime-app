...
function LineChart({ nodes, internet }: Props) {
    ...
    const totalHeight = internet
        ...
        : (nodes.length + 1) * circleSpacing; // Height of the path
    const totalGreenLine = (nodes.length + 1) * circleSpacing;
    ...
    return (
        <svg height={totalHeight}>
            <line
                ...
                className={
                    internet ? "stroke-primary-dark" : "stroke-secondary"
                }
                strokeWidth="3"
            />
            ...
            {internet && (
                <>
                    <line
                        x1={circleSpacing}
                        y1={totalGreenLine - circleSpacing}
                        x2={circleSpacing}
                        y2={totalGreenLine}
