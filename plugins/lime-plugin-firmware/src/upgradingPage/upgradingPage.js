...
export const UpgradeSuccess = ({ onReload, upgradeConfirmAvailable }) => (
    <div className="container container-padded container-center">
        ...
        <button onClick={onReload}>
            <Trans>Try reloading the app</Trans>
        </button>
        {upgradeConfirmAvailable && (
            <span>
                <b>
                    <Trans>
                        When reloading the app you will be asked to confirm the
                        upgrade, otherwise it will be reverted
                    </Trans>
                </b>
            </span>
        )}
...
export const UpgradeProgress = ({ elapsedTime, totalTime }) => {
    ...
    return (
        <div className="container container-padded container-center">
            ...
            <span>
                <Trans>
                    Please wait patiently for {remainingTime} seconds and do not
...
export const UpgradingPage = ({ upgradeConfirmAvailable }) => {
    ...
    if (elapsedTime < totalTime) {
        return (
            <UpgradeProgress elapsedTime={elapsedTime} totalTime={totalTime} />
        );
    }
