...
import { StatusAndButton } from "components/status/statusAndButton";
...
export const BottomSheetFooter = ({
    ...
    const Synced = () => {
        ...
        return <StatusAndButton status={"success"}>{txt}</StatusAndButton>;
    };
    ...
    const UpdateReference = () => {
        ...
        return (
            <StatusAndButton status={"warning"} btn={btn}>
                {txt}
            </StatusAndButton>
        );
    };
